...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
	 ...
	 * UUID} and {@code leastSigBits} becomes the least significant 64 bits of the
	 * {@code UUID}.
	 *
	...
	/**
	 * Static factory to retrieve a type 3 (name based) {@code UUID} based on the
	...
	/**
	 * Creates a {@code UUID} from the string standard representation as described
	 ...
	 * time_hi fields of this {@code UUID}. The resulting timestamp is measured in
	 ...
	 * object, has the same variant, and contains the same value, bit for bit, as
	 * this {@code UUID}.
	 *
	 ...
	 *
	 * @return -1, 0 or 1 as this {@code UUID} is less than, equal to, or greater
	 *         than {@code val}
	 *
	 */
