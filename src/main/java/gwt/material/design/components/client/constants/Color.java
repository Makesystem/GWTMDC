...
public enum Color implements CssType {
	...
	//
	MDC_THEME_SECONDARY("var(" + ThemeAttribute.MDC_THEME_SECONDARY + ")"),
	//
	MDC_THEME_BACKGROUND("var(" + ThemeAttribute.MDC_THEME_BACKGROUND + ")"),
	//
	MDC_THEME_SURFACE("var(" + ThemeAttribute.MDC_THEME_SURFACE + ")"),
	//
	MDC_THEME_ON_PRIMARY("var(" + ThemeAttribute.MDC_THEME_ON_PRIMARY + ")"),
	//
	MDC_THEME_ON_SECONDARY("var(" + ThemeAttribute.MDC_THEME_ON_SECONDARY + ")"),
	//
