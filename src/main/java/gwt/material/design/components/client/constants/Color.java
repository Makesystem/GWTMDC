...
public enum Color implements CssType {
	// THEME
	MDC_THEME_PRIMARY(var(ThemeProperty.MDC_THEME_PRIMARY)),
	//
	MDC_THEME_SECONDARY(var(ThemeProperty.MDC_THEME_SECONDARY)),
	//
	MDC_THEME_BACKGROUND(var(ThemeProperty.MDC_THEME_BACKGROUND)),
	//
	MDC_THEME_SURFACE(var(ThemeProperty.MDC_THEME_SURFACE)),
	//
	MDC_THEME_ON_PRIMARY(var(ThemeProperty.MDC_THEME_ON_PRIMARY)),
	//
	MDC_THEME_ON_SECONDARY(var(ThemeProperty.MDC_THEME_ON_SECONDARY)),
	//
	MDC_THEME_TEXT_PRIMARY_ON_BACKGROUND(var(ThemeProperty.MDC_THEME_TEXT_PRIMARY_ON_BACKGROUND)),
	//
	MDC_THEME_TEXT_SECONDARY_ON_BACKGROUND(var(ThemeProperty.MDC_THEME_TEXT_SECONDARY_ON_BACKGROUND)),
	//
	MDC_THEME_TEXT_HINT_ON_BACKGROUND(var(ThemeProperty.MDC_THEME_TEXT_HINT_ON_BACKGROUND)),
	//
	MDC_THEME_TEXT_DISABLED_ON_BACKGROUND(var(ThemeProperty.MDC_THEME_TEXT_DISABLED_ON_BACKGROUND)),
	//
	MDC_THEME_TEXT_ICON_ON_BACKGROUND(var(ThemeProperty.MDC_THEME_TEXT_ICON_ON_BACKGROUND)),
	//
	MDC_THEME_ON_SURFACE(var(ThemeProperty.MDC_THEME_ON_SURFACE)),
	//
	MDC_THEME_SUCCESS(var(ThemeProperty.MDC_THEME_SUCCESS)),
	//
	MDC_THEME_WARNING(var(ThemeProperty.MDC_THEME_WARNING)),
	//
	MDC_THEME_ERROR(var(ThemeProperty.MDC_THEME_ERROR)),
	//
	MDC_THEME_ON_SUCCESS(var(ThemeProperty.MDC_THEME_ON_SUCCESS)),
	//
	MDC_THEME_ON_WARNING(var(ThemeProperty.MDC_THEME_ON_WARNING)),
	//
	MDC_THEME_ON_ERROR(var(ThemeProperty.MDC_THEME_ON_ERROR)),
	// BLACK
	/**
	...
	// TRANSPARENT
	/**
	 * The color TRANSPARENT with an RGB value of rgba(0, 0, 0, 0).
	 * <div style="border:1px solid
	...
	// TRANSPARENT
	/**
	 * The color TRANSLUCENT with an RGB value of rgba(127, 127, 127, 0.5).
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgba(127, 127, 127,
	 * 0.5);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	TRANSLUCENT(127, 127, 127, 0.5),
	// RED
	/**
	 * The color RED with an RGB value of rgb(244, 67, 54).
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(244, 67,
	 * 54);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED(244, 67, 54),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 235,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 205,
	 * 210);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_100(255, 205, 210),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(239, 154,
	 * 154);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_200(239, 154, 154),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(229, 115,
	 * 115);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_300(229, 115, 115),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(239, 83,
	 * 80);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_400(239, 83, 80),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(229, 57,
	 * 53);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_600(229, 57, 53),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(211, 47,
	 * 47);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_700(211, 47, 47),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(198, 40,
	 * 40);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_800(198, 40, 40),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(183, 28,
	 * 28);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_900(183, 28, 28),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 138,
	 * 128);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 82,
	 * 82);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_A200(255, 82, 82),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 23,
	 * 68);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_A400(255, 23, 68),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(213, 0,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	RED_A700(213, 0, 0),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(233, 30,
	 * 99);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	PINK(233, 30, 99),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(252, 228,
	 * 236);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	PINK_50(252, 228, 236),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(248, 187,
	 * 208);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(244, 143,
	 * 177);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(240, 98,
	 * 146);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	PINK_300(240, 98, 146),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(236, 64,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(216, 27,
	 * 96);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	PINK_600(216, 27, 96),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(194, 24,
	 * 91);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	PINK_700(194, 24, 91),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(173, 20,
	 * 87);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	PINK_800(173, 20, 87),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(136, 14,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 128,
	 * 171);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 64,
	 * 129);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(245, 0,
	 * 87);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	PINK_A400(245, 0, 87),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(197, 17,
	 * 98);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	PINK_A700(197, 17, 98),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(156, 39,
	 * 176);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	PURPLE(156, 39, 176),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(243, 229,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(225, 190,
	 * 231);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(206, 147,
	 * 216);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(186, 104,
	 * 200);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(171, 71,
	 * 188);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(142, 36,
	 * 170);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(123, 31,
	 * 162);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(106, 27,
	 * 154);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(74, 20,
	 * 140);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(234, 128,
	 * 252);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(224, 64,
	 * 251);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(213, 0,
	 * 249);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(170, 0,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(103, 58,
	 * 183);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(237, 231,
	 * 246);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(209, 196,
	 * 233);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(179, 157,
	 * 219);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(149, 117,
	 * 205);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(126, 87,
	 * 194);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(94, 53,
	 * 177);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(81, 45,
	 * 168);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(69, 39,
	 * 160);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(49, 27,
	 * 146);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(179, 136,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(124, 77,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(101, 31,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(98, 0,
	 * 234);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(63, 81,
	 * 181);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	INDIGO(63, 81, 181),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(232, 234,
	 * 246);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(197, 202,
	 * 233);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(159, 168,
	 * 218);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(121, 134,
	 * 203);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(92, 107,
	 * 192);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(57, 73,
	 * 171);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(48, 63,
	 * 159);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(40, 53,
	 * 147);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(26, 35,
	 * 126);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(140, 158,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(83, 109,
	 * 254);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(61, 90,
	 * 254);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(48, 79,
	 * 254);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(33, 150,
	 * 243);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BLUE(33, 150, 243),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(227, 242,
	 * 253);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BLUE_50(227, 242, 253),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(187, 222,
	 * 251);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(144, 202,
	 * 249);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(100, 181,
	 * 246);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(66, 165,
	 * 245);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BLUE_400(66, 165, 245),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(30, 136,
	 * 229);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BLUE_600(30, 136, 229),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(25, 118,
	 * 210);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BLUE_700(25, 118, 210),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(21, 101,
	 * 192);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BLUE_800(21, 101, 192),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(13, 71,
	 * 161);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BLUE_900(13, 71, 161),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(130, 177,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(68, 138,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(41, 121,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(41, 98,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BLUE_A700(41, 98, 255),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(3, 169,
	 * 244);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(225, 245,
	 * 254);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(179, 229,
	 * 252);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(129, 212,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(79, 195,
	 * 247);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(41, 182,
	 * 246);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(3, 155,
	 * 229);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(2, 136,
	 * 209);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(2, 119,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(1, 87,
	 * 155);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(128, 216,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(64, 196,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 176,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 145,
	 * 234);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 188,
	 * 212);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	CYAN(0, 188, 212),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(224, 247,
	 * 250);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	CYAN_50(224, 247, 250),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(178, 235,
	 * 242);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(128, 222,
	 * 234);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(77, 208,
	 * 225);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	CYAN_300(77, 208, 225),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(38, 198,
	 * 218);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	CYAN_400(38, 198, 218),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 172,
	 * 193);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	CYAN_600(0, 172, 193),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 151,
	 * 167);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	CYAN_700(0, 151, 167),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 131,
	 * 143);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	CYAN_800(0, 131, 143),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 96,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(132, 255,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(24, 255,
	 * 25);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 229,
	 * 255);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	CYAN_A400(0, 229, 255),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 184,
	 * 212);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	CYAN_A700(0, 184, 212),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 150,
	 * 136);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	TEAL(0, 150, 136),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(224, 242,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(178, 223,
	 * 219);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(128, 203,
	 * 196);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(77, 182,
	 * 172);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	TEAL_300(77, 182, 172),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(38, 166,
	 * 154);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	TEAL_400(38, 166, 154),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 137,
	 * 123);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	TEAL_600(0, 137, 123),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 121,
	 * 107);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	TEAL_700(0, 121, 107),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 105,
	 * 92);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	TEAL_800(0, 105, 92),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 77,
	 * 64);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	TEAL_900(0, 77, 64),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(167, 255,
	 * 235);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(100, 255,
	 * 218);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(29, 233,
	 * 182);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 191,
	 * 165);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	TEAL_A700(0, 191, 165),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(76, 175,
	 * 80);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	GREEN(76, 175, 80),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(232, 245,
	 * 233);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(200, 230,
	 * 201);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(165, 214,
	 * 167);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(129, 199,
	 * 132);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(102, 187,
	 * 106);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(67, 160,
	 * 71);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	GREEN_600(67, 160, 71),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(56, 142,
	 * 60);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	GREEN_700(56, 142, 60),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(46, 125,
	 * 50);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	GREEN_800(46, 125, 50),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(27, 94,
	 * 32);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	GREEN_900(27, 94, 32),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(185, 246,
	 * 202);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(105, 240,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 230,
	 * 118);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(0, 200,
	 * 83);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	GREEN_A700(0, 200, 83),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(139, 195,
	 * 74);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(241, 248,
	 * 233);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(220, 237,
	 * 200);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(197, 225,
	 * 165);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(174, 213,
	 * 129);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(156, 204,
	 * 101);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(124, 179,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(104, 159,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(85, 139,
	 * 47);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(51, 105,
	 * 30);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(204, 255,
	 * 144);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(178, 255,
	 * 89);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(118, 255,
	 * 3);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(100, 221,
	 * 23);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(205, 220,
	 * 57);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	LIME(205, 220, 57),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(249, 251,
	 * 231);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	LIME_50(249, 251, 231),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(240, 244,
	 * 195);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(230, 238,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(220, 231,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(212, 225,
	 * 87);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	LIME_400(212, 225, 87),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(192, 202,
	 * 51);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	LIME_600(192, 202, 51),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(175, 180,
	 * 43);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	LIME_700(175, 180, 43),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(158, 157,
	 * 36);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	LIME_800(158, 157, 36),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(130, 119,
	 * 23);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	LIME_900(130, 119, 23),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(244, 255,
	 * 129);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(238, 255,
	 * 65);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(198, 255,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	LIME_A400(198, 255, 0),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(174, 234,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	LIME_A700(174, 234, 0),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 235,
	 * 59);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	YELLOW(255, 235, 59),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 253,
	 * 231);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 249,
	 * 196);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 245,
	 * 157);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 241,
	 * 118);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 238,
	 * 88);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(253, 216,
	 * 53);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(251, 192,
	 * 45);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(249, 168,
	 * 37);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(245, 127,
	 * 23);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 255,
	 * 141);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 234,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 214,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 193,
	 * 7);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	AMBER(255, 193, 7),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 248,
	 * 225);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 224,
	 * 130);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 213,
	 * 79);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 202,
	 * 40);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 179,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	AMBER_600(255, 179, 0),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 160,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	AMBER_700(255, 160, 0),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 143,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	AMBER_800(255, 143, 0),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 111,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	AMBER_900(255, 111, 0),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 229,
	 * 127);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 215,
	 * 64);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 196,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 171,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 152,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	ORANGE(255, 152, 0),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 243,
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 224,
	 * 178);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 204,
	 * 128);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 183,
	 * 77);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 167,
	 * 38);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(251, 140,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(245, 124,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(239, 108,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(230, 81,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	ORANGE_900(230, 81, 0),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 209,
	 * 128);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 145,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 109,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 87,
	 * 34);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(251, 233,
	 * 231);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 171,
	 * 145);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 112,
	 * 67);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(244, 81,
	 * 30);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(230, 74,
	 * 25);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(216, 67,
	 * 21);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(191, 54,
	 * 12);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 158,
	 * 128);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 110,
	 * 64);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(255, 61,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(221, 44,
	 * 0);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(121, 85,
	 * 72);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BROWN(121, 85, 72),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(239, 235,
	 * 233);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(215, 204,
	 * 200);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(188, 170,
	 * 164);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(161, 136,
	 * 127);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(141, 110,
	 * 99);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(109, 76,
	 * 65);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BROWN_600(109, 76, 65),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(93, 64,
	 * 55);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BROWN_700(93, 64, 55),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(78, 52,
	 * 46);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BROWN_800(78, 52, 46),
	 ...
	 * <div style="border:1px solid
	 * black;width:40px;height:20px;background-color:rgb(62, 39,
	 * 35);float:right;margin: 0 10px 0 0"></div><br/>
	 * <br/>
	 */
	BROWN_900(62, 39, 35),
	...
	Color(final int red, final int green, final int blue, double alpha) {
		this.css = toRGBA(red, green, blue, alpha);
		this.hex = toHex(red, green, blue);
		this.luminance = ColorHelper.luminance(this.hex);
	}
	...
	public Color onColor() {
		return luminance < 0 ? null : ColorHelper.isDark(luminance) ? Color.WHITE : Color.BLACK;
	}

	final static String toRGBA(final int red, final int green, final int blue, double alpha) {
		return "rgba(" + red + "," + green + "," + blue + "," + alpha + ")";
	}

	final static String toHex(final int red, final int green, final int blue) {
		final StringBuilder sb = new StringBuilder();
		sb.append('#').append(toHex(red)).append(toHex(green)).append(toHex(blue));
		return sb.toString();
	}

	final static String toHex(final int value) {
		final String hex = Integer.toHexString(value);
		return (hex.length() == 1 ? "0" : "") + hex;
	}

	final static int convert(final String hex) {
		switch (hex.length()) {
		case 0:
			return 0;
		case 1:
			return Integer.valueOf(hex + hex, 16);
		case 2:
	 ...
	 * @return
	 */
	public final static Color fromStyleName(final String styleName) {
	 ...
	 * @return
	 */
	public final static Color fromCssValue(final String cssValue) {

		Color color;

		color = fromRGB(cssValue);

		if (color != null)
			return color;

		color = fromHEX(cssValue);

		if (color != null)
			return color;

		try {
			return Color.valueOf(cssValue.toUpperCase());
	...
	public static Color fromHEX(final String hex) {
		try {
			...
			final String value = hex.replaceAll("[^0-9a-fA-F]", "");
			final int length = value.length();

			if (length < 3)
				return null;

			final int quotient = length / 3;

			final int red = convert(value.substring(0, quotient));
			final int green = convert(value.substring(quotient, quotient * 2));
			final int blue = convert(value.substring(quotient * 2, quotient * 3));
	...
	/**
	 * 
	 * @param rgb can be a rgb or rgba value
	 * @return
	 */
	public static Color fromRGB(final String rgb) {
		...
		try {
			...
			final String[] vars = rgb.replaceAll("[^0-9,.]", "").split(",", -1);

			if (vars.length < 3)
				return null;

			final int red = Integer.valueOf(vars[0]);
			final int green = Integer.valueOf(vars[1]);
			final int blue = Integer.valueOf(vars[2]);
	...
	public static Color fromRGB(final int red, final int green, final int blue) {
		return EnumHelper.fromStyleName(toRGBA(red, green, blue, 1), Color.class, null);
	}
	
    final static String var(final ThemeProperty property) {
    	return var(property.getCssName());
    }
    
    final static String var(final String property) {
    	return "var(" + property + ")";
    }
}
