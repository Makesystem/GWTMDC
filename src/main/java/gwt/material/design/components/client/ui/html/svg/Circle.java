...
public class Circle extends MaterialWidget {
	...
	protected final AttributeMixin<Circle, Double> cxMixin = new AttributeMixin<>(this, HTMLAttributes.CX, FromString.TO_DOUBLE);
	protected final AttributeMixin<Circle, Double> cyMixin = new AttributeMixin<>(this, HTMLAttributes.CY, FromString.TO_DOUBLE);
	protected final AttributeMixin<Circle, Double> rMixin = new AttributeMixin<>(this, HTMLAttributes.R, FromString.TO_DOUBLE);
