...
public class MaterialUIObject extends ComplexPanel implements HasId, HasFlexbox {
	...
	public void appendTo(final Element element) {
		appendTo(element, true);
	}

	public void appendTo(final Element element, final boolean fireEvent) {
	 ...
	 * -----------------------------------------------------------------------------
	 */
	public final void setAnimation(final String animation) {
		setCssProperty("-webkit-animation", animation);
		setCssProperty("-moz-animation", animation);
		setCssProperty("-o-animation", animation);
		setCssProperty("animation", animation);
	}
